...
//
//public class Exercise01 extends TestAction{
...
//
//    public Exercise01(WebDriver driver, String webUrl, Properties properties) {
//        super(driver, webUrl, properties);
//    }
//    public static void main(String[] args) {
//        new Driver().useEdge().execute((driver)-> new Exercise01(driver, webUrl, properties)
...
//    // @FindBy(how = How.XPATH, using = "")
//    // public WebElement signInPath;
//    public Exercise01 login(String userName, String userPassword) {
//
//        PrintColor.green("-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-");
//        try {
//            get(webUrl)
