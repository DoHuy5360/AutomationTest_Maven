...
public class LearningGathering {
    ...
    public static void main(String[] args) {
        ...
        // new Petstore(driver.useChrome(),
        // "https://petstore.octoperf.com/actions/Catalog.action",
        // configFile).login().signOut().quit();
        // new Globalsqa(driver.useChrome(),
        // "https://www.globalsqa.com/angularJs-protractor/BankingProject/#/login",configFile).login().quit();
        // new
        // Elearning(driver.useChrome(),"https://elearning.vanlanguni.edu.vn/",configFile).login().openDashboard();
    }
}
